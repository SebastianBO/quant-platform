...
export default async function AdvertisingRevenuePage({ params }: Props) {
  ...
  const schemas = [
    ...
    getTableSchema({
      name: `${symbol} Advertising Revenue History`,
      description: `Historical Advertising Revenue data for ${companyName} (${symbol})`,
      url: pageUrl,
      columns: ['Period', 'Advertising Revenue', 'Change'],
      rowCount: 5,
    }),
  ]
