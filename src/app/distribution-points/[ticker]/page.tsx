...
export default async function DistributionPointsPage({ params }: Props) {
  ...
  const schemas = [
    ...
    getTableSchema({
      name: `${symbol} Distribution Points History`,
      description: `Historical Distribution Points data for ${companyName} (${symbol})`,
      url: pageUrl,
      columns: ['Period', 'Distribution Points', 'Change'],
      rowCount: 5,
    }),
  ]
