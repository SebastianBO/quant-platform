      ...
      <main className="min-h-screen bg-black text-white pt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <nav className="text-sm text-[#868f97] mb-6" aria-label="Breadcrumb">
            <Link href="/" className="hover:text-white motion-safe:transition-all motion-safe:duration-150 ease-out focus-visible:ring-2 focus-visible:ring-[#4ebe96] rounded">
              Home
            </Link>
            {' / '}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
            <div className="bg-white/[0.03] backdrop-blur-[10px] p-6 rounded-2xl border border-white/[0.08]">
              <div className="text-3xl font-bold text-[#4ebe96] mb-2 tabular-nums">
                {upcomingIPOs.length}
              </div>
              <div className="text-sm text-[#868f97]">Upcoming IPOs</div>
            </div>
            <div className="bg-white/[0.03] backdrop-blur-[10px] p-6 rounded-2xl border border-white/[0.08]">
              <div className="text-3xl font-bold text-[#4ebe96] mb-2 tabular-nums">
                {recentIPOs.length}
              </div>
              <div className="text-sm text-[#868f97]">Recent IPOs</div>
            </div>
            <div className="bg-white/[0.03] backdrop-blur-[10px] p-6 rounded-2xl border border-white/[0.08]">
              <div className="text-3xl font-bold text-[#4ebe96] mb-2 tabular-nums">
                {ipoPipeline.length}
              </div>
              <div className="text-sm text-[#868f97]">IPO Pipeline</div>
            </div>
            <div className="bg-white/[0.03] backdrop-blur-[10px] p-6 rounded-2xl border border-white/[0.08]">
              <div className="text-3xl font-bold text-[#4ebe96] mb-2 tabular-nums">
                $318B
              </div>
              <div className="text-sm text-[#868f97]">Total Valuation</div>
            </div>
          </div>
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    {upcomingIPOs.map((ipo, index) => (
                      <tr key={index} className="border-t border-white/[0.08] hover:bg-white/[0.05] motion-safe:transition-all motion-safe:duration-150 ease-out">
                        <td className="p-4 font-bold">{ipo.company}</td>
                        <td className="p-4">
                          <span className="px-3 py-1 bg-[#4ebe96]/10 text-[#4ebe96] rounded-full text-sm">
                            {ipo.sector}
                          </span>
                        </td>
                        <td className="p-4 text-[#868f97]">{ipo.expectedDate}</td>
                        <td className="p-4 font-bold text-[#4ebe96] tabular-nums">{ipo.expectedValuation}</td>
                        <td className="p-4 text-[#868f97] text-sm">{ipo.description}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
                        ...
                        <tr key={index} className="border-t border-white/[0.08] hover:bg-white/[0.05] motion-safe:transition-all motion-safe:duration-150 ease-out">
                          <td className="p-4">
                            <Link
                              ...
                              className="font-bold hover:text-[#4ebe96] motion-safe:transition-all motion-safe:duration-150 ease-out focus-visible:ring-2 focus-visible:ring-[#4ebe96] rounded"
                            >
                              {ipo.company}
                            </Link>
                          </td>
                          <td className="p-4">
                            <Link
                              href={`/stock/${ipo.ticker}`}
                              className="font-mono text-[#4ebe96] hover:underline focus-visible:ring-2 focus-visible:ring-[#4ebe96] rounded tabular-nums"
                            >
                              {ipo.ticker}
                            </Link>
                          </td>
                          <td className="p-4 text-[#868f97]">{ipo.ipoDate}</td>
                          <td className="p-4 text-[#868f97] tabular-nums">{ipo.ipoPrice}</td>
                          <td className="p-4 font-bold tabular-nums">{ipo.currentPrice}</td>
                          <td className={`p-4 font-bold tabular-nums ${isPositive ? 'text-[#4ebe96]' : 'text-[#ff5c5c]'}`}>
                            {ipo.return}
                          </td>
                          <td className="p-4">
                            <span className="px-3 py-1 bg-[#4ebe96]/10 text-[#4ebe96] rounded-full text-sm">
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {ipoPipeline.map((ipo, index) => (
                <div key={index} className="bg-white/[0.03] backdrop-blur-[10px] p-6 rounded-2xl border border-white/[0.08] hover:bg-white/[0.05] hover:border-white/[0.15] motion-safe:transition-all motion-safe:duration-150 ease-out">
                  <div className="flex items-start justify-between mb-3">
                    <h3 className="text-xl font-bold">{ipo.company}</h3>
                    <span className={`px-3 py-1 rounded-full text-xs ${
                      ipo.status === 'Filed' ? 'bg-[#479ffa]/10 text-[#479ffa]' :
                      ipo.status === 'Rumored' ? 'bg-[#ffa16c]/10 text-[#ffa16c]' :
                      'bg-[#868f97]/10 text-[#868f97]'
                    }`}>
                      {ipo.status}
                    </span>
                  </div>
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      <span className="text-[#868f97] text-sm">Sector</span>
                      <span className="text-sm font-medium">{ipo.sector}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-[#868f97] text-sm">Valuation</span>
                      <span className="text-sm font-bold text-[#4ebe96] tabular-nums">{ipo.expectedValuation}</span>
                    </div>
                    <p className="text-sm text-[#868f97] pt-2 border-t border-white/[0.08]">
                      {ipo.description}
                    </p>
                  </div>
                </div>
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {Object.entries(sectorCounts).map(([sector, count]) => (
                <div key={sector} className="bg-white/[0.03] backdrop-blur-[10px] p-6 rounded-2xl border border-white/[0.08] text-center">
                  <div className="text-3xl font-bold text-[#4ebe96] mb-2 tabular-nums">{count}</div>
                  <div className="text-sm text-[#868f97]">{sector}</div>
                </div>
              ))}
            </div>
          </section>
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white/[0.03] backdrop-blur-[10px] p-6 rounded-2xl border border-white/[0.08]">
                ...
                <ul className="space-y-2 text-[#868f97]">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Revenue growth of <span className="tabular-nums">30%+</span> annually</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#4ebe96] mt-1">✓</span>
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-[#4ebe96] mt-1">✓</span>
                    <span>Strong gross margins (<span className="tabular-nums">60%+</span> for software)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#4ebe96] mt-1">✓</span>
              ...
              <div className="bg-white/[0.03] backdrop-blur-[10px] p-6 rounded-2xl border border-white/[0.08]">
                <h3 className="text-xl font-bold mb-3 text-[#ff5c5c]">
                  Red Flags to Avoid
                </h3>
                <ul className="space-y-2 text-[#868f97]">
                  <li className="flex items-start gap-2">
          ...
          <section className="mb-16 bg-white/[0.03] backdrop-blur-[10px] p-6 sm:p-8 rounded-2xl border border-white/[0.08]">
            <h2 className="text-2xl sm:text-3xl font-bold mb-6">
              How to Invest in IPOs: Step-by-Step Guide
            </h2>
            <div className="space-y-6">
              <div className="flex gap-4">
                <div className="flex-shrink-0 w-10 h-10 rounded-full bg-[#4ebe96] text-black flex items-center justify-center font-bold text-lg tabular-nums">
                  1
                </div>
                <div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-[#868f97]">
                    Many successful IPO investors wait <span className="tabular-nums">3-6</span> months after the IPO to invest, allowing initial
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-[#868f97]">
                    IPOs are inherently risky with limited track record. Keep position sizes small (<span className="tabular-nums">1-2%</span> of portfolio)
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-[#868f97]">
                    Track the lock-up expiration date (typically <span className="tabular-nums">90-180</span> days post-IPO) when insiders can sell shares.
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white/[0.03] backdrop-blur-[10px] p-6 rounded-2xl border border-white/[0.08]">
                ...
                <p className="text-[#868f97] text-sm mb-3">
                  Approximately <span className="tabular-nums">60%</span> of IPOs trade above their offer price after one year, though performance
                  varies significantly by sector and market conditions.
                </p>
                <div className="text-2xl font-bold text-[#4ebe96] tabular-nums">~60%</div>
              </div>
              ...
              <div className="bg-white/[0.03] backdrop-blur-[10px] p-6 rounded-2xl border border-white/[0.08]">
                ...
                <p className="text-[#868f97] text-sm mb-3">
                  The average IPO sees a first-day price increase of <span className="tabular-nums">10-15%</span>, though this varies widely
                  based on demand, pricing, and market conditions.
                </p>
                <div className="text-2xl font-bold text-[#4ebe96] tabular-nums">10-15%</div>
              </div>
              ...
              <div className="bg-white/[0.03] backdrop-blur-[10px] p-6 rounded-2xl border border-white/[0.08]">
                ...
                <p className="text-[#868f97] text-sm mb-3">
                  Research shows that IPOs often underperform the broader market over <span className="tabular-nums">3-5</span> years,
                  with an average <span className="tabular-nums">3</span>-year return of <span className="tabular-nums">-18%</span> relative to benchmarks.
                </p>
                <div className="text-2xl font-bold text-[#ff5c5c] tabular-nums">-18%</div>
              </div>
            </div>
          </section>
          ...
          <section className="mb-16">
            ...
            <div className="space-y-4">
              {ipoFAQs.map((faq, index) => (
                ...
                >
                  <summary className="text-lg font-bold cursor-pointer list-none flex items-center justify-between hover:text-[#4ebe96] motion-safe:transition-all motion-safe:duration-150 ease-out">
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <Link
                href="/earnings"
                className="bg-white/[0.03] backdrop-blur-[10px] p-4 rounded-2xl border border-white/[0.08] hover:bg-white/[0.05] hover:border-white/[0.15] motion-safe:transition-all motion-safe:duration-150 ease-out group focus-visible:ring-2 focus-visible:ring-[#4ebe96]"
              >
          ...
          {/* CTA Section */}
          <section className="bg-gradient-to-r from-[#4ebe96] to-[#3da87f] p-8 sm:p-12 rounded-2xl text-black text-center">
            ...
            <Link
              href="/dashboard"
              className="inline-block bg-black text-white hover:bg-white/[0.1] px-8 py-3 rounded-full font-bold motion-safe:transition-all motion-safe:duration-150 ease-out focus-visible:ring-2 focus-visible:ring-white"
            >
