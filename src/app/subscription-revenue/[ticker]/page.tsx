...
export default async function SubscriptionRevenuePage({ params }: Props) {
  ...
  const schemas = [
    ...
    getTableSchema({
      name: `${symbol} Subscription Revenue History`,
      description: `Historical Subscription Revenue data for ${companyName} (${symbol})`,
      url: pageUrl,
      columns: ['Period', 'Subscription Revenue', 'Change'],
      rowCount: 5,
    }),
  ]
