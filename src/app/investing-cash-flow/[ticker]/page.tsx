...
export default async function InvestingCashFlowPage({ params }: Props) {
  ...
  const schemas = [
    ...
    getTableSchema({
      name: `${symbol} Investing Cash Flow History`,
      description: `Historical Investing Cash Flow data for ${companyName} (${symbol})`,
      url: pageUrl,
      columns: ['Period', 'Investing Cash Flow', 'Change'],
      rowCount: 5,
    }),
  ]
