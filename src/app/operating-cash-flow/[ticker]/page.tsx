...
export default async function OperatingCashFlowPage({ params }: Props) {
  ...
  const schemas = [
    ...
    getTableSchema({
      name: `${symbol} Operating Cash Flow History`,
      description: `Historical Operating Cash Flow data for ${companyName} (${symbol})`,
      url: pageUrl,
      columns: ['Period', 'Operating Cash Flow', 'Change'],
      rowCount: 5,
    }),
  ]
