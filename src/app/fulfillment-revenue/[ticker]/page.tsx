...
export default async function FulfillmentRevenuePage({ params }: Props) {
  ...
  const schemas = [
    ...
    getTableSchema({
      name: `${symbol} Fulfillment Revenue History`,
      description: `Historical Fulfillment Revenue data for ${companyName} (${symbol})`,
      url: pageUrl,
      columns: ['Period', 'Fulfillment Revenue', 'Change'],
      rowCount: 5,
    }),
  ]
