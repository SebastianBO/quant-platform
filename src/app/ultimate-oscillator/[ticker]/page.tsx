...
export default async function UltimateOscillatorPage({ params }: Props) {
  ...
  const schemas = [
    ...
    getFAQSchema(uoFaqs),
    getTableSchema({
      name: `${symbol} Ultimate Oscillator History`,
      description: `Historical Ultimate Oscillator data for ${companyName} (${symbol})`,
      url: pageUrl,
      columns: ['Period', 'Ultimate Oscillator', 'Change'],
      rowCount: 5,
    }),
  ]
