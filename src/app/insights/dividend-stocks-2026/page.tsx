        ...
        <div className="max-w-5xl mx-auto px-6 py-12">
            ...
            <div className="bg-gradient-to-br from-blue-600/20 to-green-600/20 p-8 rounded-xl border border-blue-500/20 mb-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Attractive yields as rates stabilize and economy expands</p>
                </div>
              </div>
              <p className="text-lg">
              ...
              {dividendCategories.map((category) => (
                <div key={category.name} className="bg-card p-6 rounded-xl border border-border">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-3">
                    ...
                    <span className="text-lg font-bold text-green-500">{category.avgYield}</span>
                  </div>
                  ...
                  <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-4">
                    <div className="flex items-start gap-4 flex-1">
                      <div className="flex-shrink-0 w-12 h-12 bg-blue-600/20 rounded-lg flex items-center justify-center">
                        <span className="text-xl font-bold text-blue-400">#{stock.rank}</span>
                      </div>
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-1 flex-wrap">
                          <h3 className="text-2xl font-bold">{stock.ticker}</h3>
                          <span className="text-lg font-bold text-green-500">{stock.yield}</span>
                          <span className="text-xs px-2 py-1 bg-blue-600/20 text-blue-400 rounded-full">{stock.category}</span>
                        </div>
                        <p className="text-sm text-muted-foreground mb-1">{stock.yearsOfGrowth !== 'N/A' ? `${stock.yearsOfGrowth} years of dividend growth` : 'Dividend ETF'}</p>
                        <p className="text-muted-foreground mb-2">{stock.why}</p>
                        <p className="text-sm text-blue-400">{stock.safety}</p>
                      </div>
                    </div>
                  </div>
                  <div className="mb-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
              {allDividendStocks.map((stock, i) => (
                ...
                >
                  ...
                  <p className="text-lg font-bold group-hover:text-blue-400 transition-colors">{stock}</p>
                </Link>
              ))}
            </div>
          </section>
          ...
          <section className="mt-12 border-t border-border pt-8">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Link href="/best-stocks/dividend" className="px-4 py-2 bg-secondary rounded-lg hover:bg-secondary/80 transition-colors">
                All Dividend Stocks
              </Link>
