...
export default async function PromotionalActivityPage({ params }: Props) {
  ...
  const schemas = [
    ...
    getTableSchema({
      name: `${symbol} Promotional Activity History`,
      description: `Historical Promotional Activity data for ${companyName} (${symbol})`,
      url: pageUrl,
      columns: ['Period', 'Promotional Activity', 'Change'],
      rowCount: 5,
    }),
  ]
