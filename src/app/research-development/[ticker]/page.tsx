...
export default async function ResearchDevelopmentPage({ params }: Props) {
  ...
  const schemas = [
    ...
    getFAQSchema(rdFaqs),
    getTableSchema({
      name: `${symbol} Research Development History`,
      description: `Historical Research Development data for ${companyName} (${symbol})`,
      url: pageUrl,
      columns: ['Period', 'Research Development', 'Change'],
      rowCount: 5,
    }),
  ]
