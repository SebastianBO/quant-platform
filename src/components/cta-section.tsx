  ...
  return (
    <section id="contact" className="py-24 px-6 border-t border-white/[0.04]">
      <div className="max-w-4xl mx-auto">
        <div className="bg-white/[0.03] backdrop-blur-[10px] border border-white/[0.08] rounded-2xl p-8 md:p-12 text-center">
          ...
          <Button className="bg-[#4ebe96] text-black hover:bg-[#4ebe96]/90 motion-safe:transition-colors motion-safe:duration-100">Get in touch</Button>
        </div>
      </div>
    </section>
  )
