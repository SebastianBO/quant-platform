  ...
  return (
    <section className="py-24 px-6 bg-black">
      <div className="max-w-7xl mx-auto">
        <div className="mb-16">
          <span className="inline-block px-3 py-1 bg-white/[0.03] backdrop-blur-[10px] border border-white/[0.08] rounded-full text-xs font-medium text-white mb-4">
            Lician Pro
          </span>
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-16">
          ...
          <div className="bg-white/[0.03] backdrop-blur-[10px] border border-white/[0.08] rounded-2xl p-6 flex items-center justify-center min-h-[320px]">
            <div className="w-full max-w-md space-y-4">
              <div className="bg-white/[0.03] backdrop-blur-[10px] rounded-xl border border-white/[0.08] p-4">
                <p className="text-sm text-white mb-2">What was Apple&apos;s revenue growth in Q3?</p>
                <div className="flex items-start gap-3 mt-4">
                  <div className="w-8 h-8 rounded-full bg-white/[0.03] backdrop-blur-[10px] border border-white/[0.08] flex items-center justify-center shrink-0">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="inline-flex items-center gap-2 text-xs text-[#868f97] bg-white/[0.03] backdrop-blur-[10px] border border-white/[0.08] px-2 py-1 rounded">
