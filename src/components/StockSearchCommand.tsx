    ...
    <>
      ...
      <button
        ...
        className="flex items-center gap-2 px-3 py-2 text-sm text-muted-foreground
                   hover:text-foreground hover:bg-secondary/50 rounded-lg transition-colors"
      >
        ...
        <kbd className="hidden md:inline-flex h-5 items-center gap-1 rounded border
                        bg-muted px-1.5 text-[10px] text-muted-foreground ml-2">
            ...
            <>
              ...
              <CommandGroup heading="Quick Actions">
                <CommandItem onSelect={() => handleQuickAction("/screener")}>
                  <BarChart3 className="mr-2 w-4 h-4 text-muted-foreground" />
                  Stock Screener
                </CommandItem>
                ...
                <CommandItem onSelect={() => handleQuickAction("/markets/top-gainers")}>
                  <Flame className="mr-2 w-4 h-4 text-green-500" />
                  Top Gainers
                </CommandItem>
              ...
              <CommandGroup heading="Portfolio">
                <CommandItem onSelect={() => handleQuickAction("/dashboard/portfolios")}>
                  <Wallet className="mr-2 w-4 h-4 text-green-500" />
                  Connect Portfolio
                </CommandItem>
